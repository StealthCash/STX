...
contains(STEALTHCASH_NEED_QT_PLUGINS, 1) {
    DEFINES += STEALTHCASH_NEED_QT_PLUGINS
...
HEADERS += \
    ...
    src/qt/stealthcashgui.h \
    src/qt/stealthcashbridge.h \
...
SOURCES += \
    ...
    src/qt/stealthcashgui.cpp \
    src/qt/stealthcash.cpp \
    src/qt/stealthcashbridge.cpp \
...
macx:ICON = src/qt/res/icons/StealthCash.icns
macx:TARGET = "StealthCash"
