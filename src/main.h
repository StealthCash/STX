...
inline int64_t FutureDriftVPowStart(int64_t nTime) { return nTime + 10 * 60; }
inline int64_t FutureDriftVPosStart(int64_t nTime) { return nTime + 15; }

inline int64_t FutureDrift(int64_t nTime, int nHeight) { return Params().IsProtocolVStart(nHeight) ? FutureDriftVPosStart(nTime) : FutureDriftVPowStart(nTime); }

inline unsigned int GetTargetSpacing(int nHeight) { return Params().IsProtocolVStart(nHeight) ? 60 : 60; }
