...
public:
    ...
    const bool IsProtocolVStart(int nHeight) const { return nHeight > nMoreStakePosBlock; }
    const CBigNum& ProofOfWorkLimit() const { return bnProofOfWorkLimit; }
    const CBigNum& ProofOfStakeLimit(int nHeight) const { return IsProtocolVStart(nHeight) ? bnProofOfStakeLimit : bnProofOfStakeLimit; }
