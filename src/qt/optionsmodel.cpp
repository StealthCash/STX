...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::STX).toInt();
    ...
    fAutoRedeemStealthCash = settings.value("fAutoRedeemStealthCash", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemStealthCash:
            return fAutoRedeemStealthCash;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemStealthCash: return "AutoRedeemStealthCash";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::STX).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemStealthCash: {
            fAutoRedeemStealthCash = value.toBool();
            settings.setValue("fAutoRedeemStealthCash", fAutoRedeemStealthCash);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemStealthCash() { return fAutoRedeemStealthCash; }
