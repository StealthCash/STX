#ifndef STEALTHCASHBRIDGE_H
#define STEALTHCASHBRIDGE_H

class StealthcashGUI;
...
class StealthcashBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit StealthcashBridge(StealthcashGUI *window, QObject *parent = 0);
    ~StealthcashBridge();
