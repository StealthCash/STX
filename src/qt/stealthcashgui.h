...
#ifndef STEALTHCASHGUI_H
#define STEALTHCASHGUI_H
...
/**
  StealthCash GUI main class. This class represents the main window of the StealthCash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class StealthcashGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit StealthcashGUI(QWidget *parent = 0);
    ~StealthcashGUI();
...
private:
    ...
    friend class StealthcashBridge;
