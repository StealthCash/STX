StealthCash: Qt5 GUI for StealthCash
===============================
...
Alternatively, install Qt Creator and open the `StealthCash.pro` file.

An executable named `stealthcash` will be built.
...
installed causes stealthcash to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
